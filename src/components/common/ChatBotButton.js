...
const ChatBotButton = ({steps}) => {
  ...
  return(
    ...
    {/* 챗봇창 */}
    <div class={`rsc-container sc-iwsKbI ${chatBotOnOff ? "hgftJd" : "losXwd"}`} width="350px" height="600px">
        <div class="rsc-header sc-gqjmRU glfuN">

            <a class="rsc-header-close-button sc-jTzLTM kMqZix">
                <svg height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg" onClick={() => setChatBotOnOff((chatBotOnOff) => !chatBotOnOff)}>
